...
# Define a helper function to normalize the columns in-place
...
# Define a task that accepts the previously downloaded folder, along with some metadata about the
