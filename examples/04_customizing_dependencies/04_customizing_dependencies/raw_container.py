...
# ### calculate-ellipse-area.sh
#
# ```{literalinclude} ../../../examples/04_customizing_dependencies/raw-containers-supporting-files/per-language/shell/calculate-ellipse-area.sh
# :language: shell
# ```
#
# ### calculate-ellipse-area.py
#
# ```{literalinclude} ../../../examples/04_customizing_dependencies/raw-containers-supporting-files/per-language/python/calculate-ellipse-area.py
# :language: python
# ```
#
# ### calculate-ellipse-area.R
#
# ```{literalinclude} ../../../examples/04_customizing_dependencies/raw-containers-supporting-files/per-language/r/calculate-ellipse-area.R
# :language: r
# ```
#
# ### calculate-ellipse-area.hs
#
# ```{literalinclude} ../../../examples/04_customizing_dependencies/raw-containers-supporting-files/per-language/haskell/calculate-ellipse-area.hs
# :language: haskell
# ```
#
# ### calculate-ellipse-area.jl
#
# ```{literalinclude} ../../../examples/04_customizing_dependencies/raw-containers-supporting-files/per-language/julia/calculate-ellipse-area.jl
# :language: julia
# ```
#
