...
# Assign a `NamedTuple` to the output of `intercept` task
...
# it's often better to declare them explicitly. This helps prevent potential
# linting errors in tools like mypy.
