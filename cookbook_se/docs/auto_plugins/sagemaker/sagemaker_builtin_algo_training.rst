...
.. "auto_plugins/sagemaker/sagemaker_builtin_algo_training.py"
...
.. only:: html
    ...
    .. note::
        ...
        Click :ref:`here <sphx_glr_download_auto_plugins_sagemaker_sagemaker_builtin_algo_training.py>`
        to download the full example code

.. rst-class:: sphx-glr-example-title

.. _sphx_glr_auto_plugins_sagemaker_sagemaker_builtin_algo_training.py:
...
.. _sphx_glr_download_auto_plugins_sagemaker_sagemaker_builtin_algo_training.py:
