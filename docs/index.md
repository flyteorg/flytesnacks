...
* To quickly try out Flyte on your machine, follow the {doc}`Quickstart guide <quickstart_guide>`, then read {doc}`"Getting started with workflow development" <getting_started_with_workflow_development>`.
