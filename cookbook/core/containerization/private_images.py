...
`AWS ECR <https://docs.aws.amazon.com/AmazonECR/latest/userguide/registry_auth.html>`__,
`Docker Hub <https://docs.docker.com/docker-hub/repos/#private-repositories>`__,
`GitLab Container Registry <https://docs.gitlab.com/ee/ci/docker/using_docker_images.html#access-an-image-from-a-private-container-registry>`__,
and `GitHub Container Registry <https://docs.github.com/en/packages/working-with-a-github-packages-registry/working-with-the-container-registry#authenticating-to-the-container-registry>`__.
...
First `create a secret <https://kubernetes.io/docs/tasks/configure-pod-container/pull-image-private-registry/>`__
