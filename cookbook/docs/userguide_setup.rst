...
.. prompt:: bash $
   ...
   flytectl get workflows --project flytesnacks --domain development core.flyte_basics.basic_workflow.my_wf --version <version> -o doturl

To view workflow as a ``strict digraph`` on the command line:

.. prompt:: bash $

   flytectl get workflows --project flytesnacks --domain development core.flyte_basics.basic_workflow.my_wf --version <version> -o dot
