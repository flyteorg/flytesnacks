...
# The :py:meth:`~flytekit.configuration.Config.for_sandbox` method instantiates a connection to the demo cluster.
remote = FlyteRemote(
...
######################################################################
# :py:meth:``~flytekit.remote.remote.FlyteRemote.register_workflow`` can
# be used to register the workflow.
#
...
######################################################################
# :meth:``~flytekit.remote.remote.FlyteRemote.execute`` can be used to
