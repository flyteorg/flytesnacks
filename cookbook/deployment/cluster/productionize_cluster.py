...
* <domain>: your desired domain for your flyte deployment. This should be a domain which you own or a subdomain thereof-- this environment will promptyly take ownership of the domain/subdomain so make sure it will only be used for this purpose, e.g. mysubdomain.mydomain.com)
...
Kubernetes cluster and node pool (with encrypted disk storage). And finally, the k8s-base module sets up the resources
...
This will enable SES on your account and environment domain - you may be prompted to
...
3. Finally, go ahead and uncomment out the 'Uncomment out for SES' line in the flyte.yaml and rerun `opta apply -c flyte.yaml`.
