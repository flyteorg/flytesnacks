...
# %%
# To write to a schema object refer to :py:method:`flytekit.types.schema.FlyteSchema.open` method. Writing can be done
...
# %%
# To read a Schema, one has to invoke the :py:method:`flytekit.types.schema.FlyteSchema.open`. The default mode
