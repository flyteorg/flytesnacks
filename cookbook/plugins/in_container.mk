...
.PHONY: register
register: serialize
	flyte-cli register-files -h ${FLYTE_HOST} ${INSECURE_FLAG} -p ${PROJECT} -d development --kubernetes-service-account ${SERVICE_ACCOUNT} -v ${VERSION} $(SERIALIZED_PB_OUTPUT_DIR)/*
